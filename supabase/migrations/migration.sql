...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:96xwfdKOXsO1BVW79j1HUA==$UHiy1doJtrZOo1UNMvKnuqxKZYprxKMsfIvzJwC0bsw=:+1ByUDfYzPys/BYL0Ehq1aViudQrCzyZaWgP9ixyijk=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:r7QbzyoZucBSTxXXK1t7zg==$b7TH+S2tWlxjDwDJmtgv3x44ba7AdTLgpcDRPraVwpA=:iqlQwOekjic0L5jHq1SYWVX0TtwpEgddJ+HGFN5rMN8=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:OIm6LY9ezSPA/K9+C1z4og==$zzSjo3yaQuB8ugmJhBcpnHWHIV5V5UXsJXAjqDMwSyQ=:6s0pvMvEweIVfvuXgY7HQXA7c9rxlCSE9whcBBmJvDc=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:YF6gpILqme5W16RSoUL8VA==$KDd82NVXKDTxRwDJMfxTY0HVj2VsmI9bMz+uNiFn7U4=:x+XJBI1iXGehcaN1ExtEF/RyFTKOQvbsewPcO+s6lJM=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:lL2+NVnh2mykTI3M/m77VQ==$D3oobZQOux+EKhTckMuc9//v9aujdZlgUw96ikBCPAg=:Om0ssqGUQhEtosuv09zzBGnTg3GtlEV4+yTjeQWT6Dg=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:PRFoA9Acu3KitxxS30u9sg==$Ynyu0klaUijZ5oSxPDb7yFcv5neIMUweNyz/WoPwdGA=:ZUQ3tB0a494hrhq+ZS8j42DVlFEka+S3yD60yBxb4J4=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:61pZNA/uUMP/YOdvLzJaIA==$ayLaDY9rAbIGpkHsd9CDImnVn9c7AgSsnz1eQY8r5w8=:NeDqnjLFkSfTPr0I9J2ntebPYYTIfBduUABEBKbBZOE=';
...
CREATE TABLE "public"."conversations" (
    ...
    "agent" "text" DEFAULT 'opencode'::"text" NOT NULL,
...
--
-- Name: modified_files; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."modified_files" (
    ...
    "change_type" "text" DEFAULT 'modified'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "modified_files_change_type_check" CHECK (("change_type" = ANY (ARRAY['created'::"text", 'modified'::"text", 'deleted'::"text"])))
);
...
--
-- Name: modified_files modified_files_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."modified_files"
    ADD CONSTRAINT "modified_files_pkey" PRIMARY KEY ("id");
...
--
-- Name: modified_files modified_files_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."modified_files"
    ADD CONSTRAINT "modified_files_conversation_id_fkey" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE CASCADE;


--
-- Name: modified_files modified_files_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."modified_files"
    ADD CONSTRAINT "modified_files_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can manage own messages" ON "public"."messages" TO "authenticated" USING ((EXISTS ( SELECT 1
...
--
-- Name: modified_files Users can manage own modified files; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can manage own modified files" ON "public"."modified_files" TO "authenticated" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
--
-- Name: modified_files; Type: ROW SECURITY; Schema: public; Owner: -
--
